...
echo "===========================================================================" >> $logFile
sudo lshw -class storage >> $logFile 2>&1
sleep 1
echo >> $logFile
echo >> $logFile
echo >> $logFile
...
echo "===========================================================================" >> $logFile
sudo lshw -class power >> $logFile 2>&1
sleep 1
echo >> $logFile
echo >> $logFile
echo >> $logFile
